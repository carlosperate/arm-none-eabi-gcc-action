...
test('latest points to a known latest release', async () => {
  const knownLatestRelease = '13.2.Rel1';
...
describe('Real install in temp dirs.', () => {
  ...
  test('13.2.Rel1 linux', async () => await tmpInstall('13.2.Rel1', 'linux'));
  test('13.2.Rel1 darwin', async () => await tmpInstall('13.2.Rel1', 'darwin'));
  test('13.2.Rel1 win32', async () => await tmpInstall('13.2.Rel1', 'win32'));
});
