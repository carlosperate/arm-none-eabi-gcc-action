...
const versions: {[gccRelease: string]: {[platform: string]: UrlData}} = {
  '15.2.Rel1': {
    win32: {
      url:
        'https://developer.arm.com/-/media/Files/downloads/gnu/15.2.rel1/binrel/arm-gnu-toolchain-15.2.rel1-mingw-w64-x86_64-arm-none-eabi.zip',
    ...
    linux_aarch64: {
      url:
        'https://developer.arm.com/-/media/Files/downloads/gnu/15.2.rel1/binrel/arm-gnu-toolchain-15.2.rel1-aarch64-arm-none-eabi.tar.xz',
